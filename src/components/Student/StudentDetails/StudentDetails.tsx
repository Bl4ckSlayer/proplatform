                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start flex-col">
                          ...
                          <div className=" w-full">
                            <div className="text-sm text-gray-600 bg-slate-200 p-1 px-3 w-fit rounded-lg">
                              {course?.level}
                            </div>
                            ...
                            <div className="mt-3 flex items-center gap-2">
                              <button className="text-sm btn btn-primary btn-xs ">
                                View Course
                              </button>
                              <button className="text-sm btn btn-primary btn-xs btn-outline">
                                See Analytics
                              </button>
                            </div>
                          </div>
